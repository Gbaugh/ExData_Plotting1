...
The plot files in the GitHub repository are of the graphics file format
Each set of R code creates the reference plot



##Steps:

###Forked and cloned the GitHub repository: https://github.com/rdpeng/ExData_Plotting1
...
1. "": "Global Active Power" (kilowatts)~datetime
1. "": "Energy sub metering" ~ datetime; Sub_metering_1, Sub_metering_2, Sub_metering_3 
1. a) "Global Active Power" b)Voltage;, c)"Energy sub metering"; d) Global_reactive_power; ~ datetime
